    ...
    SubShader
    {
        ...
        Pass
        {
			...
			half4 frag( VertexOutput IN   ) : SV_TARGET
			{
				...
				half2 texCoord130 = IN.texCoord0.xy * _laserScale + ( _TimeParameters.x * ( _Speed * half2( -1,-1 ) ) );
				half gradientNoise123 = GradientNoise(texCoord130,0.8);
        ...
        Pass
        {
			...
			half4 frag( VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 texCoord130 = IN.ase_texcoord2.xy * _laserScale + ( _TimeParameters.x * ( _Speed * half2( -1,-1 ) ) );
				half gradientNoise123 = GradientNoise(texCoord130,0.8);
				gradientNoise123 = gradientNoise123*0.5 + 0.5;
        ...
        Pass
        {
			...
			half4 frag( VertexOutput IN ) : SV_TARGET
			{
				...
				half2 texCoord130 = IN.ase_texcoord.xy * _laserScale + ( _TimeParameters.x * ( _Speed * half2( -1,-1 ) ) );
				half gradientNoise123 = GradientNoise(texCoord130,0.8);
				gradientNoise123 = gradientNoise123*0.5 + 0.5;
...
ASEEND*/
//CHKSM=A026FBA07F96537946A2B5A4AF94F435F75FD6BC