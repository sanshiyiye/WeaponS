...
public class DemoSceneManager : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        if (loadedLevelName == "BulletDemoScene")
        {
            if (playerWeaponSystemRef != null)
            {
                ...
                playerWeaponSystemRef.BulletPreset = BulletPresetType.CrazySpreadPingPong;
            }
        }
        else if (loadedLevelName == "TopDownGunDemoScene")
        {
            ...
            {
                ResetPlayerWeaponSystemToBasics(playerWeaponSystemRef);
                playerWeaponSystemRef.BulletPreset = BulletPresetType.Simple;
    ...
    {
        playerWeaponSystemRef.shooterDirectionType = ShooterType.Horizonal;
        playerMovementRef.playerMovementType = PlayerMovement.PlayerMovementType.Normal;
    }

    private void SetShooterPresetTypeVertical()
    {
        playerWeaponSystemRef.shooterDirectionType = ShooterType.Vertical;
        playerMovementRef.playerMovementType = PlayerMovement.PlayerMovementType.Normal;
    }

    private void SetShooterPresetTypeFreeAim()
    {
        playerWeaponSystemRef.shooterDirectionType = ShooterType.FreeAim;
    ...
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.GatlingGun;
    }

    private void PresetShotgun()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.Shotgun;
    }

    private void PresetWildFire()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.WildFire;
    }

    private void PresetThreeShot()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.ThreeShotSpread;
    }

    private void PresetDualSpread()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.DualSpread;
    }

    private void PresetImbaCannon()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.ImbaCannon;
    }

    private void PresetShower()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.Shower;
    }

    private void PresetDualAlternating()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.DualAlternating;
    }

    private void PresetDualMachineGun()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.DualMachineGun;
    }

    private void PresetTarantula()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.Tarantula;
    }

    private void PresetCircleSpray()
    {
        playerWeaponSystemRef.BulletPreset = BulletPresetType.CircleSpray;
    }
}
