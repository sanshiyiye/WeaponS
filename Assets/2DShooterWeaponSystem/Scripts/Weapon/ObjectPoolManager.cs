...
public class ObjectPoolManager : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        for (var i = 1; i <= numLaserBullet2ToSpawn; i++)
        {
            var laserBullet = (GameObject)Instantiate(laserPrefab);
    ...
    public GameObject GetUsableLaserBullet()
    {
        GameObject obj = GetDisabledPoolObject(laserPool);
        ...
        var laserBullet = (GameObject)Instantiate(instance.laserPrefab);
